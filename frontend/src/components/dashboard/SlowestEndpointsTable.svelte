...
<div class="table-card">
  <div class="table-header">
    <span class="table-title">Endpoint Piu Lenti</span>
          ...
          {#each data as row}
            <tr>
              ...
              <td class="col-latency">
                <span class="latency-value" style="color: {getLatencyColor(row.p50)}">
                  {formatMs(row.p50)}
                </span>
              </td>
              <td class="col-latency">
                <span class="latency-value" style="color: {getLatencyColor(row.p95)}">
                  {formatMs(row.p95)}
                </span>
              </td>
              <td class="col-latency">
                <span class="latency-value" style="color: {getLatencyColor(row.p99)}">
                  {formatMs(row.p99)}
                </span>
              </td>
