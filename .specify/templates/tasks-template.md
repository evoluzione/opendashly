...
- [ ] T010 Define OTLP ingest pipeline and schema validation baseline
- [ ] T011 Define query execution baseline and saved-query storage
- [ ] T012 Establish tenant isolation and data access boundaries
